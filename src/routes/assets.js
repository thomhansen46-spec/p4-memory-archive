...
module.exports = (app) => {
  ...
  app.post('/assets', (req, res) => {
    const record = { id: uuidv4(), record_type: 'asset_record', created_at: new Date().toISOString(), updated_at: new Date().toISOString(), ...req.body };
    const data = load();
    data.push(record);
    save(data);
